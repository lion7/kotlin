...
import org.jetbrains.kotlin.fir.analysis.diagnostics.FirErrors.TYPE_PARAMETER_ON_TYPED_VALUE_CLASS_EQUALS
...
//            map.put(ILLEGAL_PROJECTION_USAGE, ...) // &
        ...
        map.put(
            ...
            "Multi-field value class primary constructor default parameters are not supported"
        )
        map.put(
