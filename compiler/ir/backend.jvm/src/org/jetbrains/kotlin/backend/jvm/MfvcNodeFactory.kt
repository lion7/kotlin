...
fun collectPropertiesOrFieldsAfterLowering(irClass: IrClass) = LinkedHashSet<IrPropertyOrIrField>().apply {
...
fun getRootNode(context: JvmBackendContext, mfvc: IrClass): RootMfvcNode {
    ...
    val customEqualsAny = mfvc.functions.singleOrNull {
        it.isEquals(context) && it.origin != IrDeclarationOrigin.GENERATED_MULTI_FIELD_VALUE_CLASS_MEMBER
    }
