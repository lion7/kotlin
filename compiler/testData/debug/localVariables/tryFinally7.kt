...
// test.kt:19 compute: y=42:number, i=0:number
// test.kt:20 compute: y=42:number, i=0:number, y=32:number
// test.kt:20 compute: y=42:number, i=0:number, y=32:number
// test.kt:20 compute: y=42:number, i=0:number, y=32:number
// test.kt:20 compute: y=42:number, i=0:number, y=32:number, j=0:number
// test.kt:22 compute: y=42:number, i=0:number, y=32:number, j=0:number
// test.kt:26 compute: y=42:number, i=0:number, y=32:number, j=0:number
