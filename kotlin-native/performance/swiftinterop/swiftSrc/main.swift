...
swiftLauncher.addBase(
    name: "WeakRefBenchmarkThreads.aliveReferences",
    benchmark: BenchmarkEntryWithInitAndValidation.companion.create(
        ctor: { return WeakRefBenchmarkThreads() },
        benchmark: { ($0 as! WeakRefBenchmarkThreads).aliveReferences() },
        validation: { ($0 as! WeakRefBenchmarkThreads).teardown() }
    )
)
swiftLauncher.addBase(
    name: "WeakRefBenchmarkThreads.deadReferences",
    benchmark: BenchmarkEntryWithInitAndValidation.companion.create(
        ctor: { return WeakRefBenchmarkThreads() },
        benchmark: { ($0 as! WeakRefBenchmarkThreads).deadReferences() },
        validation: { ($0 as! WeakRefBenchmarkThreads).teardown() }
    )
)
swiftLauncher.addBase(
    name: "WeakRefBenchmarkThreads.dyingReferences",
    benchmark: BenchmarkEntryWithInitAndValidation.companion.create(
        ctor: { return WeakRefBenchmarkThreads() },
        benchmark: { ($0 as! WeakRefBenchmarkThreads).dyingReferences() },
        validation: { ($0 as! WeakRefBenchmarkThreads).teardown() }
    )
)
