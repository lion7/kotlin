...
import org.jetbrains.kotlin.gradle.targets.native.tasks.GenerateArtifactPodspecTask.PodspecDependency
...
open class KotlinCocoapodsPlugin : Plugin<Project> {
    ...
    private fun registerPodspecTask(
        ...
        val podspecTask = project.tasks.register(podspecTaskName, GenerateArtifactPodspecTask::class.java) { task ->
            ...
            task.dependencies.set(cocoapodsExtension.pods.map { PodspecDependency(name = it.name, version = it.version) })
